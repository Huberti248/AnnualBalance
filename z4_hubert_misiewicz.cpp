// NOTE: Github repository with project file and libraries to run code included: https://github.com/Huberti248/AnnualBalance
/*
Resigned:
...
int main(int argc, char* argv[])
{
    ...
    io.Fonts->AddFontFromFileTTF("res/Jura/static/Jura-Regular.ttf", 9, 0, ranges.Data);
    io.Fonts->Build();
    ...
    while (running) {
        ...
        if (ImGui::Begin("window", 0, flags)) {
            static ImGuiTableFlags tableFlags = ImGuiTableFlags_SizingFixedFit | ImGuiTableFlags_Resizable | ImGuiTableFlags_BordersOuter | ImGuiTableFlags_BordersV | ImGuiTableFlags_ContextMenuInBody | ImGuiTableFlags_NoHostExtendX;
                ...
                for (int i = 0; i < ROW_COUNT; ++i) {
                    ...
                    for (int j = 0; j < COLUMN_COUNT; ++j) {
                        ...
                        if (j == 0) {
                            ...
                            ImGui::PushStyleColor(ImGuiCol_FrameBg, IM_COL32(163, 148, 147, 255));
